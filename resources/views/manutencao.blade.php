...
<!--                     @if (Route::has('login'))
        ...
        <footer class="mt-auto px-auto text-white-50">
                    <p class="text-white m-auto">Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }}) <br> Versão 1.5.1 alpha <br>Um Site Seinenkai/José Bruno!</p>
        </footer>
    </div>
